...
impl CTokenStream {
    pub fn new(file: PathBuf, contents: String) -> Self {
        ...
        sources_map.insert(file.clone(), SourceFile { header_guard: None, source_idx: 0 });
        ...
        Self {
            ...
            sources,
            cursor_stack: vec![
                SourceCursor { filepath: file, file_idx: 0, cursor: 0, line: 1 }
            ],
